...
This demo is currently being hosted using [Cloudflare Workers](https://developers.cloudflare.com/containers/), with a side goal of this project to initialize myself with Rust.
