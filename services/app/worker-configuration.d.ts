/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b773c2f828d5a374a9ce9529da5bd8a9)
// Runtime types generated with workerd@1.20260915.1 2026-09-07 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	VAPID__EMAIL_ADDRESS: "vapid@webgl3d.dev";
	JWT__PRIVATE_KEY: string;
	VAPID__PUBLIC_KEY: string;
	VAPID__PRIVATE_KEY: string;
	RUST_CONTAINER: DurableObjectNamespace<import("./proxy/index").RustContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./proxy/index");
		durableNamespaces: "RustContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VAPID__EMAIL_ADDRESS" | "JWT__PRIVATE_KEY" | "VAPID__PUBLIC_KEY" | "VAPID__PRIVATE_KEY">> {}
}
