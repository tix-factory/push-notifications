/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6ca1cdd32c6d167f14e390f167445fec)
// Runtime types generated with workerd@1.20251210.0 2026-09-07 
export {};
declare global {
	const VAPID__EMAIL_ADDRESS: "vapid@webgl3d.dev";
	const VAPID__PUBLIC_KEY: string;
	const VAPID__PRIVATE_KEY: string;
	const JWT__PRIVATE_KEY: string;
